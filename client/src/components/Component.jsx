...
//in other word ,hooks are functions that make functional componets work like class components
...
// If we just use a normal variable, it resets every render and we lse the ID.
